...
public class HelloWorld {
	...
	public static void main(String[] args) {
				...
				System.out.println(" OOO   O     O    O      O    O   O  O     O  O   O");
				System.out.println();
					// Math inside!
				...
				System.out.print("The circumference of a circle is " + circf + " and the area of a circle is " + vol + "." );
